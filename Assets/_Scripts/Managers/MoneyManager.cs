...
public class MoneyManager : MonoBehaviour
{
    ...
    public event Action<int> OnMoneyChanged; // yeni bakiye gönderilecek
    ...
    private void Awake()
    {
        ...
        // Persistence disabled: do not load from PlayerPrefs for this case-study/demo.
        // LoadUnlockedFromPrefs();
    }

    private void LoadUnlockedFromPrefs()
    {
        // Persistence disabled for presentation. If needed, implement loading logic here.
        /*
        // Example: parse a stored list or check known ids
        */
    }

    private void PersistUnlockedId(string id)
    {
        // Persistence disabled for presentation/demo. If you want to enable saving,
        // uncomment the following lines and the related checks elsewhere in this file.
        /*
    ...
    private bool IsPersistedUnlocked(string id)
    {
        // Persistence disabled — always return false. Kept for reference.
        // If enabling persistence, change to read PlayerPrefs as in earlier version.
        return false;
    }
