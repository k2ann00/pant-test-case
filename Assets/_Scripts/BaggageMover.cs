...
/// <summary>
/// Tek bir bavulun hareketini yöneten component
/// SOLID: Single Responsibility - Sadece bavul hareketi
/// SOLID: Open-Closed - Yeni hareket tipleri eklenebilir
/// Pattern: Component-based - Her bavul kendi mover'ına sahip
/// </summary>
public class BaggageMover : MonoBehaviour
{
    ...
    /// </summary>
    public void Initialize(Vector3 startPos, Vector3 endPos, float speed)
    {
